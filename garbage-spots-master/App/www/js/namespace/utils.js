...
const utils = {
   ...
   /** Gắn cờ các trạng thái nếu bộ tải hiện đang được mở. */
    isLoaderOpen: false,

    /** Gắn cờ các trạng thái nếu hộp thoại cảnh báo hiện đang được mở. */
    isAlertOpen: false,

    /** Gắn cờ cho các trạng thái nếu màn hình hình ảnh hiện đang được mở. */
    ...
    switchActivity: (toOpen, close = false, toClose = null) => {
        ...
        // Nếu hoạt động khác nên được đóng lại, hãy đóng nó
  ...
  /**
       * Chèn một hoạt động mới vào cuối ngăn xếp hoạt động.
       *
       * Hoạt động @param {object} - Hoạt động cần đẩy.
       * @return {number} Số lượng hoạt động hiện tại trong ngăn xếp.
       */
